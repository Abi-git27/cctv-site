  ...
  return (
    <main className="relative w-full bg-white font-sans selection:bg-black selection:text-white">
      ...
      <section className="relative w-full h-[85vh] md:h-screen overflow-hidden border-b border-gray-100 bg-white">
        ...
        {/* 3D CANVAS - SCROLL FIX APPLIED HERE */}
        <div className="absolute inset-0 z-0 mt-[-5vh] md:mt-0" style={{ touchAction: 'pan-y' }}>
        ...
        <div className="absolute bottom-[35%] md:bottom-[45%] w-full text-center z-20 pointer-events-none">
          <p className="text-[7px] md:text-[9px] font-mono text-red-600 uppercase tracking-[0.5em] opacity-80 animate-pulse italic">
      ...
      {/* SECTION 2: SPEC SELECTOR (THE STONE DESIGN) */}
      ...
      {/* SECTION 3: FIELD REPORTS (REVIEWS) */}
            ...
            {reviews.map((rev, i) => (
              <div key={i} className="group p-8 border border-gray-100 hover:border-black transition-all duration-500 bg-gray-50/30">
                <div className="flex gap-1 mb-6">
                  {[...Array(5)].map((_, star) => (<div key={star} className="w-2 h-2 bg-red-600" />))}
                </div>
      ...
      {/* SECTION 4: INTELLIGENCE BRIEFING (FAQ) */}
